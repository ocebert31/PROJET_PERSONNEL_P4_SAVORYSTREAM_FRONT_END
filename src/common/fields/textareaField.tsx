...
function TextareaField<TFieldValues extends FieldValues>({ id, register, name, disabled,
  required, ariaDescribedBy, ariaInvalid }: InputFieldProps<TFieldValues>) {
    const baseClass = "ds-input-radius w-full border border-border bg-background px-4 py-3 text-foreground placeholder:text-muted/70 transition focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/25";
    return (

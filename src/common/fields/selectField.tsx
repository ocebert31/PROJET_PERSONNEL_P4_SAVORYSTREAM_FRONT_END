...
function SelectField<TFieldValues extends FieldValues>({ id, register, name, disabled, options = [],
  ...
  const baseClass = "ds-input-radius w-full border border-border bg-background px-4 py-3 text-foreground transition focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/25";
